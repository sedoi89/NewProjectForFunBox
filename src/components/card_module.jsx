...
const CardModule = (props) => {
        ...
        <div className={`background ${props.entered} ${props.leave} ${props.disabled? 'disabled-color' : ''}`}>
            <svg width="320" height="480" viewBox="0 0 320 480" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <mask id="path-2-inside-1_37_381" fill="white">
